...
[Service]
Type=oneshot
ExecStart=/usr/bin/backup.sh /etc/backup-tools/mc@fabric_kmz.conf
----
...
[Service]
Type=oneshot
ExecStart=/usr/bin/backup.sh /etc/backup-tools/httpd.conf
----
...
[Service]
Type=oneshot
ExecStart=/usr/bin/backup.sh /etc/backup-tools/paths.conf
----
